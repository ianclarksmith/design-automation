...
# Functions
#===========================================================================
def acoustic_response(type, frequency):
    """
...
#------------------------------------------------------------------------------ 
def adjacencies(sampleSize, shading, ignore = ""):
    """
...
def resources(type):
    ...
    p2e._app.Exec(arg_str)
#------------------------------------------------------------------------------ 
def shading_percentage(cumulative, startDay, stopDay, startTime, 
    ...
    p2e._app.Exec(arg_str)
#------------------------------------------------------------------------------ 
def thermal_temperatures(calc_type, zone = 0):
    """
...
#------------------------------------------------------------------------------ 
def set_material_default(sky, level):
    """
...
def set_window_cond(cleanliness):
    """
