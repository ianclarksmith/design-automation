...
class Masks(object):
    ...
    def copy(self, from_mask, to_mask):
        """
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("masks.copy", from_mask, to_mask )
    ...
    def update(self, index):
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("masks.update", index)
        p2e._app.Exec(arg_str)
    ...
    def get_data(self, index, i, j):
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("get.masks.data", index, i, 
                                                     j)
        val = p2e._app.Request(arg_str)
    ...
    def set_data(self, index, i, j, value):
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("set.masks.data", index, i, 
                                                     j, value)
        p2e._app.Exec(arg_str)
    ...
    def get_object(self, index):
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("get.masks.object", index)
        val = p2e._app.Request(arg_str)
        return p2e._base._util._convert_str_to_type(val, int)
    ...
    def set_object(self, index, object):
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("set.masks.object", index, 
                                                      object)
        p2e._app.Exec(arg_str)
    ...
    def get_shading(self, index, azi, alt):
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("get.masks.shading", index, 
                                                     azi, alt)
        val = p2e._app.Request(arg_str)
        return p2e._base._util._convert_str_to_type(val, float)
    ...
    def set_shading(self, index, azi, alt, value):
        ...
        """
        arg_str = p2e._base._util._convert_args_to_string("set.masks.shading", index, 
                                                     azi, alt, value)
        p2e._app.Exec(arg_str)
