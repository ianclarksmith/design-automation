...
def frame(index):
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("grid3d.getframe", index)
...
def set_frame(index):
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("grid3d.setframe", index)
    p2e._app.Exec(arg_str)
...
def set_cell_cfd_blockage(cell_index, state):
    """
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("set.grid3d.blockage", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2], state)
    p2e._app.Exec(arg_str)

def cell_value(cell_index, index = 0):
    """
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("get.grid3d.cell", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2], index)
...
def set_cell_value(cell_index, value, index = 0):
    """
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("set.grid3d.cell", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2], value, 
                                                  index)
...
def cell_index(point):
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("get.grid3d.index", 
                                                  point[0],
                                                  point[1], 
                                                  point[2])
    val = p2e._app.Request(arg_str)
    return p2e._base._util._convert_str_to_list(val, float, float, float, bool)
...
def cell_position(cell_index):
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("get.grid3d.position", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2])
    val = p2e._app.Request(arg_str)
...
def cell_state(cell_index):
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("get.grid3d.state", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2])
    val = p2e._app.Request(arg_str)
...
def set_cell_state(cell_index, state):
    """
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("set.grid3d.state", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2], state)
    p2e._app.Exec(arg_str)

def cell_value_by_point(point, index = 0):
    """
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("get.grid3d.value", 
                                                  point[0],
                                                  point[1], 
                                                  point[2], 
                                                  index)
    val = p2e._app.Request(arg_str)
    return p2e._base._util._convert_str_to_list(val, int, bool)

def cell_vector(cell_index):
    """
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("get.grid3d.vector", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2])
    val = p2e._app.Request(arg_str)
...
def set_cell_vector(cell_index, vector):
    """
    ...
    """
    arg_str = p2e._base._util._convert_args_to_string("set.grid3d.vector", 
                                                  cell_index[0], 
                                                  cell_index[1], 
                                                  cell_index[2], 
                                                  vector[0], 
