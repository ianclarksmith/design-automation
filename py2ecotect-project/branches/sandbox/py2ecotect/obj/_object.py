...
class _Object(object):
    ...
    def __init__(self, object_eco_id, points):
        ...
        self.child = _Object.child(object_eco_id)
        self.func = _Object.func(object_eco_id)
        self.modf = _Object.modf(object_eco_id)
        self.mtrl = _Object.mtrl(object_eco_id)
        self.node = _Object.node(object_eco_id)
        self.prop = _Object.prop(object_eco_id)
        self.state = _Object.state(object_eco_id)
        self.trfm = _Object.trfm(object_eco_id)
        self.dupl = _Object.dupl(object_eco_id)        
    ...
    def zone():  
        def fget(self):
            ...
            arg_str = p2e._util._convert_args_to_string("get.object.zone", 
                                                         self.eco_id)
            val = p2e._app.Request(arg_str)
            return p2e.doc._zones[p2e._util._convert_str_to_type(val, int)]
