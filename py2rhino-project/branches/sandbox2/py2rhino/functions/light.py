...
def add_point_light(point):

    return _rsf.add_point_light(point)

def add_rectangular_light(origin, width, height):

    return _rsf.add_rectangular_light(origin, width, height)

def add_spot_light(origin, radius, apex):
...
def is_directional_light(object):

    return _rsf.is_directional_light(object)

def is_light(object):

    return _rsf.is_light(object)

def is_light_enabled(object):

    return _rsf.is_light_enabled(object)

def is_light_reference(object):

    return _rsf.is_light_reference(object)

def is_linear_light(object):

    return _rsf.is_linear_light(object)

def is_point_light(object):

    return _rsf.is_point_light(object)

def is_rectangular_light(object):

    return _rsf.is_rectangular_light(object)

def is_spot_light(object):
...
def light_objects():
    ...
    return _rsf.light_objects()

def rectangular_light_plane(object):
