...
def add_curve(points, degree=None):
...
def add_fillet_curve(curve_0, curve_1, radius=None, point_0=None, point_1=None):
...
def add_interp_curve(points, degree=None, knot_style=None, start_tan=None, end_tan=None):

    return _rsf.add_interp_curve(points, degree, knot_style, start_tan, end_tan)

def add_interp_curve_ex(points, degree=None, knot_style=None, sharp=None, start_tangent=None, end_tangent=None):
...
def arc_angle(object, index=None):

    return _rsf.arc_angle(object, index)

def arc_center_point(object, index=None):

    return _rsf.arc_center_point(object, index)

def arc_mid_point(object, index=None):

    return _rsf.arc_mid_point(object, index)

def arc_radius(object, index=None):

    return _rsf.arc_radius(object, index)

def circle_center_point(object, index=None):

    return _rsf.circle_center_point(object, index)

def circle_circumference(object, index=None):

    return _rsf.circle_circumference(object, index)

def circle_radius(object, index=None):

    return _rsf.circle_radius(object, index)

def close_curve(object, tolerance=None):

    return _rsf.close_curve(object, tolerance)

def convert_curve_to_polyline(object, angle_tolerance=None, tolerance=None, delete_input=None):

    return _rsf.convert_curve_to_polyline(object, angle_tolerance, tolerance, delete_input)

def curve_arc_length_point(object, length, from_start=None):
...
def curve_arrows(object, style=None):
...
def curve_brep_intersect(curve, brep, tolerance=None):
...
def curve_closest_point(object, point, index=None):

    return _rsf.curve_closest_point(object, point, index)

def curve_contour_points(object, start_point, end_point, interval=None):
...
def curve_curve_intersection(object_1, object_2=None, tolerance=None):

    return _rsf.curve_curve_intersection(object_1, object_2, tolerance)

def curve_degree(object, index=None):
...
def curve_dim(object, index=None):
...
def curve_domain(object, index=None):

    return _rsf.curve_domain(object, index)

def curve_edit_points(object, return_parameters=None, index=None):

    return _rsf.curve_edit_points(object, return_parameters, index)

def curve_end_point(object, index=None):
...
def curve_fillet_points(curve_0, curve_1, radius=None, base_point_0=None, base_point_1=None):
...
def curve_knot_count(object, index=None):

    return _rsf.curve_knot_count(object, index)

def curve_knots(object, index=None):

    return _rsf.curve_knots(object, index)

def curve_length(object, index=None, sub_domain=None):
...
def curve_point_count(object, index=None):

    return _rsf.curve_point_count(object, index)

def curve_points(object, index=None):

    return _rsf.curve_points(object, index)

def curve_radius(object, point, index=None):
...
def curve_start_point(object, index=None):

    return _rsf.curve_start_point(object, index)

def curve_surface_intersection(curve, surface, tolerance=None, angle_tolerance=None):

    return _rsf.curve_surface_intersection(curve, surface, tolerance, angle_tolerance)

def curve_tangent(object, parameter, index=None):

    return _rsf.curve_tangent(object, parameter, index)

def curve_weights(object, index=None):

    return _rsf.curve_weights(object, index)

def divide_curve(object, segments, create=None, points=None):

    return _rsf.divide_curve(object, segments, create, points)

def divide_curve_equidistant(object, distance, create=None, points=None):

    return _rsf.divide_curve_equidistant(object, distance, create, points)

def divide_curve_length(object, length, create=None, points=None):
...
def evaluate_curve(object, parameter, index=None):

    return _rsf.evaluate_curve(object, parameter, index)

def explode_curves(objects, delete=None):
...
def fair_curve(object, tolerance=None):

    return _rsf.fair_curve(object, tolerance)

def fit_curve(object, degree=None, tolerance=None, angle_tolerance=None):

    return _rsf.fit_curve(object, degree, tolerance, angle_tolerance)

def insert_curve_knot(object, parameter, symmetrical=None):

    return _rsf.insert_curve_knot(object, parameter, symmetrical)

def is_arc(object, index=None):

    return _rsf.is_arc(object, index)

def is_circle(object, index=None):

    return _rsf.is_circle(object, index)

def is_curve(object, index=None):

    return _rsf.is_curve(object, index)

def is_curve_closable(object, tolerance=None):

    return _rsf.is_curve_closable(object, tolerance)

def is_curve_closed(object, index=None):

    return _rsf.is_curve_closed(object, index)

def is_curve_in_plane(object, plane=None):

    return _rsf.is_curve_in_plane(object, plane)

def is_curve_linear(object, index=None):

    return _rsf.is_curve_linear(object, index)

def is_curve_periodic(object, index=None):

    return _rsf.is_curve_periodic(object, index)

def is_curve_planar(object, index=None):

    return _rsf.is_curve_planar(object, index)

def is_curve_rational(object, index=None):
...
def is_line(object, index=None):

    return _rsf.is_line(object, index)

def is_point_on_curve(object, point, index=None):

    return _rsf.is_point_on_curve(object, point, index)

def is_poly_curve(object, index=None):

    return _rsf.is_poly_curve(object, index)

def is_polyline(object, index=None):

    return _rsf.is_polyline(object, index)

def join_curves(object, delete=None):
...
def make_curve_non_periodic(object, delete=None):

    return _rsf.make_curve_non_periodic(object, delete)

def make_curve_periodic(object, delete=None):
...
def offset_curve(object, direction, distance, normal=None, style=None):
...
def planar_closed_curve_containment(curve_1, curve_2, plane=None, tolerance=None):

    return _rsf.planar_closed_curve_containment(curve_1, curve_2, plane, tolerance)

def planar_curve_collision(curve_1, curve_2, plane=None, tolerance=None):

    return _rsf.planar_curve_collision(curve_1, curve_2, plane, tolerance)

def point_in_planar_closed_curve(point, curve, plane=None, tolerance=None):

    return _rsf.point_in_planar_closed_curve(point, curve, plane, tolerance)

def poly_curve_count(object, index=None):

    return _rsf.poly_curve_count(object, index)

def polyline_vertices(object, index=None):
...
def rebuild_curve(object, degree=None, point_count=None):
...
def simplify_curve(object, flags=None):

    return _rsf.simplify_curve(object, flags)

def split_curve(object, parameters, delete=None):

    return _rsf.split_curve(object, parameters, delete)

def trim_curve(object, interval, delete=None):
