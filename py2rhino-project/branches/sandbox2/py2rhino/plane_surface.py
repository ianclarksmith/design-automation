...
class PlaneSurface(_SurfaceRoot):
    ...
    def __init__(self, _rhino_id):
        ...
        self.defm = _ObjectRootDefm(_rhino_id, PlaneSurface, _rsf )
        self.eval = _SurfaceRootEval(_rhino_id, PlaneSurface, _rsf )
        self.func = _SurfaceRootFuncOorc(_rhino_id, PlaneSurface, _rsf )
        self.genr = _SurfaceRootGenr(_rhino_id, PlaneSurface, _rsf )
        self.grps = _ObjectRootGrps(_rhino_id, PlaneSurface, _rsf )
        self.modf = _SurfaceRootMdfy(_rhino_id, PlaneSurface, _rsf )
        self.mtrl = _ObjectRootMtrl(_rhino_id, PlaneSurface, _rsf )
        self.prop = _ObjectRootProp(_rhino_id, PlaneSurface, _rsf )
        self.rndr = _ObjectRootRndr(_rhino_id, PlaneSurface, _rsf )
        self.stat = _ObjectRootStat(_rhino_id, PlaneSurface, _rsf )
        self.test = _SurfaceRootTest(_rhino_id, PlaneSurface, _rsf )
        self.trfm = _ObjectRootTrfm(_rhino_id, PlaneSurface, _rsf )
        self.util = _ObjectRootUtil(_rhino_id, PlaneSurface, _rsf )
