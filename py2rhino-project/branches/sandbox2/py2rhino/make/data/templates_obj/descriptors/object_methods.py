...
#------------------------------------------------------------------------------ 
#methods / functions - need to be split
...
object_mesh_max_aspect_ratio = {
    "method_location": "_Object",
    "method_type": "METHOD",
    "method_name": "mesh_max_aspect_ratio",
...
object_mesh_max_dist_edge_to_srf = {
    "method_location": "_Object",
    "method_type": "METHOD",
    "method_name": "mesh_max_dist_edge_to_srf",
...
object_mesh_max_edge_length = {
    "method_location": "_Object",
    "method_type": "METHOD",
    "method_name": "mesh_max_edge_length",
...
object_mesh_min_edge_length = {
    "method_location": "_Object",
    "method_type": "METHOD",
    "method_name": "mesh_min_edge_length",
    "method_parameters": (("","self","REQ"),("length","dbl","OPT")),
    "method_returns": ("boolean","boolean","null")
    }
object_mesh_min_initial_grid_quads = {
    "method_location": "_Object",
    "method_type": "METHOD",
    "method_name": "mesh_min_initial_grid_quads",
