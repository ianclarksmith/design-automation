...
get_box = {
    ...
    "method_type": "FUNCTION",
    "method_name": "get_box",
    "method_parameters": (("mode","int","OPT"),("point","array_of dbl","OPT"),("prompt1","str","OPT"),("prompt2","str","OPT"),("prompt3","str","OPT")),
    "method_returns": ("array","null")
    }
get_color = {
    "method_location": "user_interface",
...
get_distance = {
    ...
    "method_parameters": (("point","array_of dbl","OPT"),("distance","dbl","OPT"),("message1","str","OPT"),("message2","str","OPT")),
    "method_returns": ("number","null")
    }
get_integer = {
    "method_location": "user_interface",
...
get_points = {
    ...
    "method_parameters": (("draw","bln","OPT"),("plane","bln","OPT"),("message1","str","OPT"),("message2","str","OPT"),("max_points","int","OPT"),("base_point","array_of dbl","OPT")),
    "method_returns": ("array","null")
    }
get_print_width = {
    "method_location": "user_interface",
